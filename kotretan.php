$car = Cars::create([
    ...
    'slug' => 'suzukiGrandVitara',
    'carInformation' => 'Suzuki Vitara merupakan kendaraan SUV yang diproduksi oleh perusahaan Jepang, Suzuki sejak tahun 1988 untuk pasaran global. Mobil ini dikenal dengan berbagai macam nama, antara lain Sidekick di AS tahun 1988 sampai 1998 dan Indonesia dari tahun 1995 hingga 2001, Escudo di Jepang sejak 1988 dan Indonesia dari tahun 1994 hingga 2006, Vitara di AS, Eropa Barat, Bolivia, Ecuador, Filipina, Hong Kong, dan Taiwan sejak 1999, dan Grand Vitara di Inggris, Eropa Timur, Asia Selatan, Karibia, Afrika Selatan, Iran, Kanada, dan Australia. Versi yang lebih besar juga tersedia, dikenal dengan nama Suzuki Grand Escudo (atau Grand Vitara XL-7). Nama ini diambil dari "escudo", mata uang Portugal sebelum digunakannya Euro.',
    'image' => 'suzukiGrandVitara.jpg',
    'category_id' => '1'])
    ...
    'carModel' => 'Elgrand',
    'slug' => 'nissanElgrand',
    'carInformation' => 'Nissan Elgrand adalah MPV mewah yang dibuat oleh Nissan sejak tahun 1997. Sampai tahun 2012, mobil ini telah mengalami 3 generasi pengembangan, yaitu E50, E51, dan E52 yang diluncurkan tahun 2010. Kompetitor dari Nissan Elgrand diantaranya Toyota Alphard/Toyota Vellfire.',
    'image' => 'nissanElgrand.jpg',
    'category_id' => '2'])
